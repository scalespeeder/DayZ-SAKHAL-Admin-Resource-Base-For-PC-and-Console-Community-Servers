DayZ Sakhal "Admin Spawn Tent Base" For Console and PC json Custom Spawner Mod Instructions & Terms Of Use

This custom object spawner json file will spawn in an Admin Tent with truck & parts at the Airfield on Sakhal,  7176.08, 7135.050 . There are a couple of boats on the beach nearby too.

PLEASE NOTE THAT AS THE TRUCK & BOATS ARE NOT ASSOCIATED WITH AN EVENT THEY WILL DESPAWN ON NEXT SERVER RESTART OR IF ABANDONED.

PLEASE NOTE THAT I DO NOT RECOMEND YOU HAVE THIS BASE LIVE ALL THE TIME BECAUSE IT COULD SEVERELY ALTER THE LOOT TABLE ON YOUR SERVER!
...
(Optional: For advanced users I have included the original DayZ Editor Mod file "sakhal-admin-base.dze" which can be imported into DayZ Editor Mod on PC for customisation.)
...
Upload "sakhal-admin-base-airfield.json" from the extracted files to inside the "custom" folder of the mission directory on your server. This file places the tent and items on your map.
...
Edit it to look like this: 
	...
	"objectSpawnersArr": ["custom/sakhal-admin-base-airfield.json"],
	
If you already are calling custom jsons to spawn items, seperate the files like this:

	"objectSpawnersArr": ["custom/sakhal-admin-base-airfield.json","custom/anotherfile.json","custom/differentfile.json"],
...
Instructions To Ensure Truck & BOATS Doesn't De-Spawn On Server Restarts:
...
BELOW IS OPTIONAL AS THE SPAWNING METHOD HAS CHANGED SINCE I ORGINALLY MADE THIS BASE FOR CHERNARUS, PLUS IT'S RELATIVELY
WASY TO GET ACROSS SAKHAL TO GET TO THE AIRFIELD, OR SPAWN IN WITH CUSTOM GEAR THAT MAKES IT SO.

I HAVE NOT TESTED THIS BELOW METHOD TO SPAWN NEAR THE SAKHAL ADMIN TENT!
...
<pos x="7178.08" z="7137.050" /> <!-- player will spawn near admin tent-->
